...
})(
  {
      ...
      function(n, e, t) {
        ...
        function i(n, e) {
          return e
            ? (e &&
                !e.c &&
                (e = { t: e.t, min: e.t, max: e.t, sos: e.t * e.t, c: 1 }),
              (e.c += 1),
              (e.t += n),
              (e.sos += n * n),
              n > e.max && (e.max = n),
        ...
        function s(n) {
          for (var e = {}, t = "", r = !1, o = 0; o < n.length; o++)
            (t = n[o]), (e[t] = u(d[t])), e[t].length && (r = !0), delete d[t];
          return r ? e : null;
        }
        function u(n) {
    ...
    3: [
      function(n, e, t) {
        function r(n, e, t) {
          "string" == typeof e &&
            ("/" !== e.charAt(0) && (e = "/" + e),
            (v.customTransaction = (t || "http://custom.transaction") + e));
        }
        function o(n, e) {
          var t = e ? e - v.offset : n;
          d.store("cm", "finished", { name: "finished" }, { time: t }),
            i(n, { name: "finished", start: t + v.offset, origin: "nr" }),
      ...
      function(n, e, t) {
        ...
        function o(n) {
          return null === n || void 0 === n
            ? "null"
            : encodeURIComponent(n).replace(l, r);
        }
        function i(n, e) {
    ...
    8: [
      function(n, e, t) {
        function r(n) {
          if (n.info.beacon) {
            n.info.queueTime &&
              b.store("measures", "qt", { value: n.info.queueTime }),
              n.info.applicationTime &&
                b.store("measures", "ap", { value: n.info.applicationTime }),
            ...
            if (t) {
              ...
              o.push(g.param("xx", n.info.extra)),
                o.push(g.param("ua", n.info.userAttributes)),
                o.push(g.param("at", n.info.atts));
        ...
        function u(n, e, t, r) {
          ...
          a && "events" === e
            ...
            : a
            ? (s = y(t.body))
            : (u = o + g.obj(t.body, n.maxBytes));
          var c = i(u, s);
          return (
            c || i !== w.beacon || (c = w.img(o + g.obj(t.body, n.maxBytes))), c
          );
        }
        function c(n) {
        ...
        function f(n) {
          return n.info.transactionName
            ? g.param("to", n.info.transactionName)
            : g.param("t", n.info.tNamePlain || "Unnamed Transaction");
        }
        function d(n, e) {
          var t = q[n] || (q[n] = []);
          t.push(e);
    ...
    10: [
      function(n, e, t) {
        ...
        (window.NREUM.setToken = d),
          6 === n(9) ? (l.maxBytes = 2e3) : (l.maxBytes = 3e4),
          (l.releaseIds = {});
        var h = u(r);
        !p || navigator.sendBeacon ? i("pagehide", h) : i("beforeunload", h),
          i("unload", h),
          f("mark", s.mark, "api"),
          s.mark("done"),
          m("api"),
            ...
            if (0 === n[e].indexOf("NREUM=")) {
              for (
                var t,
                  ...
                  o,
                  i,
                  s = n[e].substring("NREUM=".length).split("&"),
                  u = 0;
                u < s.length;
                u++
              )
              ...
              if (t) {
                ...
                (i = c == t),
                  i || (i = a(document.location.href) == t && c == r);
              }
              if (i && o) {
          ...
          switch (typeof t) {
            ...
            case "object":
              ...
              if (
                ...
                for (var s = t.length, u = 0; u < s; u += 1)
                  r[u] = i(u, t) || "null";
      ...
      function(n, e, t) {
        ...
        (r.jsonp = function o(n, o) {
          ...
          (r.xhr = function(n, e, t) {
            ...
            return (
              r.setRequestHeader("content-type", "text/plain"), r.send(e), r
            );
          }),
    ...
    21: [
      function(n, e, t) {
        ...
        function i(n, e) {
          var t = a(e);
          return t
            ? (f(t.func) ? (n.wrapperSeen = !0) : n.stackLines.push(e),
              n.wrapperSeen || n.frames.push(t),
              n)
            : (n.stackLines.push(e), n);
        }
        function a(n) {
          var e = n.match(w);
          return (
        ...
        function s(n) {
          ...
          var t = e + ": " + n.message + "\n    at " + n.sourceURL;
          return (
            n.line && ((t += ":" + n.line), n.column && (t += ":" + n.column)),
            {
              mode: "sourceline",
              name: e,
              message: n.message,
      ...
      function(n, e, t) {
        ...
        function a(n) {
          for (var e = f(p.origin), t = 0; t < n.frames.length; t++) {
            ...
            a &&
              a !== r.url &&
              ((r.url = a), (n.stackString = n.stackString.split(i).join(a)));
          }
          return n;
        }
        function s(n, e, t) {
          if (((e = e || p.now()), t || !p.onerror || !p.onerror(n))) {
            ...
            o.message && (c.message = "" + o.message),
              v[c.stackHash]
                ? (c.browser_stack_hash = l(o.stackString))
                : ((v[c.stackHash] = !0), (c.stack_trace = o.stackString)),
              (c.releaseIds = x(p.releaseIds));
            var f = r(c);
            h[f] || ((c.pageview = 1), (h[f] = !0));
            var m = t ? "ierr" : "err",
              g = { time: e };
            b("errorAgg", [m, f, c, g]),
              null != c._interactionId
                ? ((j[c._interactionId] = j[c._interactionId] || []),
                  j[c._interactionId].push([m, f, c, g]))
                : u.store(m, f, c, g);
          }
        }
        var u = n(2),
        ...
        if ((n(16), p.features.err)) {
          ...
          y.on("jserrors", function() {
            ...
            return (
              "{}" !== t && (e.qs.ri = t),
              n && n.err && n.err.length && !E && ((e.qs.pve = "1"), (E = !0)),
              e
            );
          }),
            y.pingErrors(p),
            ...
            k.on("interactionSaved", function(n) {
              j[n.id] &&
                (j[n.id].forEach(function(e) {
                  var t = e[1] + n.root.attrs.id,
                    r = e[2];
                  (r.browserInteractionId = n.root.attrs.id),
                    delete r._interactionId,
                    r._interactionNodeId &&
                      ((r.parentNodeId = r._interactionNodeId.toString()),
                      delete r._interactionNodeId),
                    u.store(e[0], t, r, e[3]);
                }),
                delete j[n.id]);
            }),
            k.on("interactionDiscarded", function(n) {
              j[n.id] &&
                (j[n.id].forEach(function(n) {
                  var e = n[2];
                  delete e._interactionId,
                    delete e._interactionNodeId,
                    u.store(n[0], n[1], n[2], n[3]);
                }),
                delete j[n.id]);
            });
        }
    ...
    25: [
      function(n, e, t) {
        ...
        document.referrer && (i = l(document.referrer)),
          f("api-setCustomAttribute", o, "api"),
          a.on("feat-ins", function() {
            f("api-addPageAction", r),
              d.on("ins", function() {
                var n = {
                  qs: { ua: s.info.userAttributes, at: s.info.atts },
                  body: { ins: g }
                };
                return (g = []), n;
              }),
          ...
          for (e in n)
            (t = n[e]),
              "number" == typeof t &&
                ...
                t < o &&
                ((r = n[e] - x.offset),
                l({ n: e, s: r, e: r, o: "document", t: "timing" }));
        }
        function o(n, e, t, r) {
          var o = "timer";
        ...
        function s(n, e) {
          ...
          if (n && n instanceof XMLHttpRequest) {
            ...
            n &&
              ...
              n.id && (t += "#" + n.id),
              n.className && (t += "." + A(n.classList).join(".")));
          return (
            "unknown" === t &&
              (e === document
                ? (t = "document")
                : e === window
                ? (t = "window")
                : e instanceof FileReader && (t = "FileReader")),
            t
          );
        }
        function u(n, e, t) {
      ...
      function(n, e, t) {
        e.exports = function(n) {
          ...
          !r.port &&
            ...
            (r.hostname = e.hostname || t.hostname),
            (r.pathname = e.pathname),
            (r.protocol = o[0]),
            "/" !== r.pathname.charAt(0) && (r.pathname = "/" + r.pathname);
          var i =
              !e.protocol || ":" === e.protocol || e.protocol === t.protocol,
    ...
    31: [
      function(n, e, t) {
        function r(n, e, t) {
          ...
          for (var r = -1, o = t - e || 0, i = Array(o < 0 ? 0 : o); ++r < o; )
            i[r] = n[e + r];
          return i;
        }
        e.exports = r;
    ...
    33: [
      function(n, e, t) {
        function r(n, e, t) {
          var r = 0;
          for (
            "undefined" == typeof t && ((t = n[0]), (r = 1)), r;
            r < n.length;
            r++
          )
            t = e(t, n[r]);
